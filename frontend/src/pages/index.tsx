...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="relative py-16 mb-12 overflow-hidden text-white bg-gradient-to-r from-primary-600 to-primary-800">
        ...
        <div className="container relative z-10 px-4 mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-block p-4 mb-8 rounded-lg bg-white/10 backdrop-blur-sm">
      ...
      <div className="max-w-4xl px-4 mx-auto mb-16">
        <div className="overflow-hidden shadow-lg bg-gradient-to-r from-secondary-500 to-secondary-700 rounded-xl">
          <div className="md:flex">
            ...
            <div className="relative md:w-1/3">
              ...
              <div className="relative flex items-center justify-center h-full p-6">
                <div className="p-4 rounded-lg shadow-lg bg-white/90 backdrop-blur">
