    ...
    <>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col mb-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="inline-flex p-1 mt-4 bg-white rounded-lg shadow-sm md:mt-0">
            <button
          ...
          <>
            <div className="grid grid-cols-1 gap-6 mb-8 md:grid-cols-3">
              <Card className="p-6 text-center">
                <div className="mb-2 text-4xl font-bold text-primary-600">{totalXP}</div>
                <div className="text-gray-600">Total XP</div>
              </Card>

              <Card className="p-6 text-center">
                <div className="mb-2 text-4xl font-bold text-secondary-600">{currentStreak}</div>
                <div className="text-gray-600">Day Streak</div>
              </Card>

              <Card className="p-6 text-center">
                <div className="mb-2 text-4xl font-bold text-green-600">{totalStudyTime}</div>
            ...
            <div className="grid grid-cols-1 gap-8 mb-8 md:grid-cols-2">
              <Card className="p-6">
                <h3 className="mb-4 text-lg font-semibold text-gray-800">Level Progress</h3>
              ...
              <Card className="p-6">
                <h3 className="mb-4 text-lg font-semibold text-gray-800">Study Time by Category</h3>
                <div className="space-y-3">
                  {Object.entries(categoryTotals).map(([category, data]) => (
                    <div key={category}>
                      <div className="flex items-center justify-between mb-1">
                        <span className={`${getCategoryColor(category)} font-medium`}>
