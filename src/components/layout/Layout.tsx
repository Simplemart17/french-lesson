...
const Layout = ({ children }: LayoutProps) => {
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900 dark:text-gray-100">
      ...
      <footer className="py-8 mt-12 bg-white border-t border-gray-100 shadow-sm dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300">
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            <div className="md:col-span-2">
              <h3 className="mb-4 text-xl font-bold text-gray-800 dark:text-gray-100">French Tutor AI</h3>
              <p className="mb-4 text-gray-600 dark:text-gray-400">Your personal assistant for learning French from beginner to advanced levels.</p>
              <p className="text-sm text-gray-500 dark:text-gray-500">© {new Date().getFullYear()} French Tutor AI. All rights reserved.</p>
            </div>
            <div>
              <h4 className="mb-3 font-semibold text-gray-800 dark:text-gray-100">Learn</h4>
            ...
            <div>
              <h4 className="mb-3 font-semibold text-gray-800 dark:text-gray-100">Company</h4>
              <ul className="space-y-2">
